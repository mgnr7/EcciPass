function Footer() {
  return (
    <footer className="dark:bg-gray-800 text-white border-t-4 block relative inset-x-0 bottom-0 p-6 bg-white shadow md:flex md:items-center md:justify-between">

    ...
    <div>
      ...
      <div class="grid grid-cols-5 gap-3 text-center ">
        <div class="col-span-4 text-center">
          ...
          <div className="text-justify mt-8 px-28">
            <p className="text-lg">
              ...
              de inscribir activos electrónicos cómo: tables, computadoras
          ...
          <div className="flex justify-center  mb-4">
            <div className="mt-12 block p-6 max-w-screen-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 ">
              ...
              <p class="px-4 text-lg font-normal text-gray-700 dark:text-gray-400 text-justify mt-4">
                1. Inicie sesión o regístrese <br></br> <br></br> 2. Seleccione
                la opción de "Registrar Dispositivo" <br></br> <br></br> 3.
                Ingrese los datos indicados de su Dispositivo y oprima "agregar
                dispositivo" <br></br> <br></br> 4. El estado de su dispositivo
                se mantenrá en "Revisión" hasta que un administrativo lo acepte{" "}
        ...
        <div class="some-class">hola 2</div>
      </div>
    </div>
  );
}
